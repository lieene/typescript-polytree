...
namespace Typing
{
  ...
  export type Simplify<O extends Node | NodeX | Tree | TreeX> =
    O extends Node | NodeX ?
  ...
  export type Nomalize<O extends SimpleNode | NodeX | SimpleTree | TreeX> =
    O extends SimpleNode | NodeX ?
  ...
  export type Edit<O extends SimpleNode | Node | SimpleTree | Tree> =
    O extends SimpleNode | Node ?
