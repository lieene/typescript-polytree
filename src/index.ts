...
export function Tree<N extends object, T extends object>(mode: 'Simple', treeExt?: T): Typing.MorphTreeTS<T>;
export function Tree<N extends object, T extends object>(mode: 'Reandonly', treeExt?: T): Typing.MorphTreeT<T>;
export function Tree<N extends object, T extends object>(mode: 'Editable', treeExt?: T): Typing.MorphTreeTX<T>;
export function Tree<N extends object, T extends object>(treeExt?: T): Typing.MorphTreeTX<T>;
