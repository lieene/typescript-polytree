...
namespace Typing {
  ...
  export interface INodeEditing<TNode extends INodeEditing<TNode, TTree>, TTree extends ITreeEditing<TNode, TTree>> {
    ...
    push<N extends object>(morph: 'morph', ext: (node: TNode) => N): MorphNodeNX<L.Extend<ExtOverNodeN<TNode>, N>>;
    ...
    add<N extends object>(morph: 'morph', ext: (node: TNode) => N): MorphNodeNX<L.Extend<ExtOverNodeN<TNode>, N>>;
  ...
  export interface ITreeEditing<TNode extends INodeEditing<TNode, TTree>, TTree extends ITreeEditing<TNode, TTree>> {
    ...
    add<N extends object>(morph: 'morph', ext: (node: TNode) => N): MorphTreeNX<L.Extend<ExtOverNodeN<TNode>, N>>;
  ...
  export interface ISimpleNode<TNode extends ISimpleNode<TNode, TTree>, TTree extends ISimpleTree<TNode, TTree>> extends INodeSimple<TNode, TTree>, INode2Tree<TTree> {
    ...
    morph<N extends object>(): SimpleMorphNode<L.Extend<ExtOverNodeN<TNode>, N>, ExtOverTreeT<TTree>>;
    //morph<N extends object>(): L.Extend<ISimpleNode<>,N>;
  ...
  export interface ISimpleTree<TNode extends ISimpleNode<TNode, TTree>, TTree extends ISimpleTree<TNode, TTree>> extends ITreeSimple<TNode, TTree>, ITree2Node<TNode> {
    ...
    morph<T extends object>(): SimpleMorphTreeT<L.Extend<ExtOverTreeT<TTree>, L.Extend<ExtOverNodeN<TNode>, T>>>;
    polymorph<N extends object, T extends object>(): SimpleMorphTree<L.Extend<ExtOverNodeN<TNode>, N>, L.Extend<ExtOverTreeT<TTree>, T>>;
  ...
  export interface ITree<TNode extends INode<TNode, TTree>, TTree extends ITree<TNode, TTree>> extends ITreeAccess<TNode, TTree>, ITree2Node<TNode> {
    poly<T extends object>(): L.Extend<TTree, T>;
    morph<T extends object>(): MorphTree<ExtOverNodeT<TNode>, L.Extend<ExtOverTreeT<TTree>, T>>;
    polymorph<N extends object, T extends object>(): MorphTree<L.Extend<ExtOverNodeN<TNode>, N>, L.Extend<ExtOverTreeT<TTree>, T>>;
  ...
  export interface IEditTree<TNode extends IEditNode<TNode, TTree>, TTree extends IEditTree<TNode, TTree>> extends ITreeEditing<TNode, TTree>, ITreeAccess<TNode, TTree>, ITree2Node<TNode> {
    ...
    polymorph<N extends object>(nodeExt: (node: TNode) => N): MorphTreeX<ExtOverTreeT<TTree>, L.Extend<ExtOverNodeN<TNode>, N>>;
    polymorph<N extends object[]>(...ext: N): MorphTreeX<ExtOverTreeT<TTree>, L.Extend<ExtOverNodeN<TNode>, L.MergTupleType<N>>>;
    polymorph<N extends object, T extends object[]>(nodeExt?: (node: TNode) => N, ...ext: T): MorphTreeX<L.Extend<ExtOverNodeN<TNode>, N>, L.Extend<ExtOverTreeT<TTree>, L.MergTupleType<T>>>;
  ...
  export type ExtOverNodeN<TNode extends object> = Omit<TNode, keyof CNode>; // L.ExcludeO<TNode, CNode>;
  export type ExtOverNodeT<TTree extends object> = Omit<NodeType<TTree>, keyof CNode>; //L.ExcludeO<NodeType<TTree>, CNode>;
  export type ExtOverTreeN<TNode extends object> = Omit<TreeType<TNode>, keyof CTree>; //L.ExcludeO<TreeType<TNode>, CTree>;
  export type ExtOverTreeT<TTree extends object> = Omit<TTree, keyof CTree>; //L.ExcludeO<TTree, CTree>;
  ...
  export type Simplify<O extends Tree0 | Node0> = O extends Node0 ? SimpleMorphNode<ExtOverNodeN<O>, ExtOverTreeN<O>> : SimpleMorphTree<ExtOverNodeT<O>, ExtOverTreeT<O>>;
  ...
  export function Simplify<O extends Tree | TreeX | Node | NodeX>(obj: O): any {
    return obj as any;
  }
  ...
  export function Nomalize<O extends SimpleTree | TreeX | SimpleTree | NodeX>(obj: O): any {
    return obj as any;
  }
