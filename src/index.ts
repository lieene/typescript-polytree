...
namespace Typing {
  ...
  export type MorphNodeX<N extends object, T extends object> = PolyNodeX<N, T> & L.MergO<N>;
  ...
  export type Simplify<O extends Node | NodeX | Tree | TreeX> = O extends Node | NodeX
    ? SimpleMorphNode<L.ExcludeO<O, CNode>, L.ExcludeO<O extends { tree: infer TTree } ? (TTree extends object ? TTree : object) : object, CTree>>
    : SimpleMorphTree<L.ExcludeO<O extends { root: infer TNode } ? (TNode extends object ? TNode : object) : object, CNode>, L.ExcludeO<O, CTree>>;

  export type Nomalize<O extends SimpleNode | NodeX | SimpleTree | TreeX> = O extends SimpleNode | NodeX
    ? MorphNode<L.ExcludeO<O, CNode>, L.ExcludeO<O extends { tree: infer TTree } ? (TTree extends object ? TTree : object) : object, CTree>>
    : MorphTree<L.ExcludeO<O extends { root: infer TNode } ? (TNode extends object ? TNode : object) : object, CNode>, L.ExcludeO<O, CTree>>;

  export type Edit<O extends SimpleNode | Node | SimpleTree | Tree> = O extends SimpleNode | Node
    ? MorphNodeX<L.ExcludeO<O, CNode>, L.ExcludeO<O extends { tree: infer TTree } ? (TTree extends object ? TTree : object) : object, CTree>>
    : MorphTreeX<L.ExcludeO<O extends { root: infer TNode } ? (TNode extends object ? TNode : object) : object, CNode>, L.ExcludeO<O, CTree>>;
  ...
  export function Edit<O extends Tree | SimpleTree | Node | SimpleNode>(obj: O): Edit<O> {
    return obj as any;
  }
