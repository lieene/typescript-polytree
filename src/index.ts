...
namespace Typing {
  ...
  export type Simplify<O extends Node | NodeX | Tree | TreeX> = O extends Node | NodeX ? SimpleMorphNode<ExtOverNodeN<O>, ExtOverTreeN<O>> : SimpleMorphTree<ExtOverNodeT<O>, ExtOverTreeT<O>>;

  export type Nomalize<O extends SimpleNode | NodeX | SimpleTree | TreeX> = O extends SimpleNode | NodeX ? MorphNode<ExtOverNodeN<O>, ExtOverTreeN<O>> : MorphTree<ExtOverNodeT<O>, ExtOverTreeT<O>>;

  export type Edit<O extends SimpleNode | Node | SimpleTree | Tree> = O extends SimpleNode | Node ? MorphNodeX<ExtOverNodeN<O>, ExtOverTreeN<O>> : MorphTreeX<ExtOverNodeT<O>, ExtOverTreeT<O>>;
  ...
  export function Edit<O extends Tree | SimpleTree | Node | SimpleNode>(obj: O): any {
    //Edit<O>
    return obj as any;
  }
